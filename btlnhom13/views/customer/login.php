...
<head>
    ...
    <style>
        ...
        button { width:100%; padding:12px 18px; border:none; background:#2b6cb0; color:#fff; font-weight:600; border-radius:12px; cursor:pointer; }
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="muted">Sử dụng tài khoản đã đăng ký để tra cứu.</div>
            ...
            <?php endif; ?>
            <form action="/btlnhom13/handle/customer_login_process.php" method="POST">
            ...
            <div class="links">
                <a class="link" href="/btlnhom13/views/customer/register.php">Đăng ký</a>
